var editor = function () {
    $("[data-editor='true']").each(function(i, item) {
        if ($("[data-editor-id='e" + i + "']").html() == undefined) {
			...
			tool += '<button class="btn btn-default" title="Justify" data-cedit="justify"><span class="glyphicon glyphicon-align-justify"></span></button>';
            tool += '</div>';
//            tool += '<div class="btn-group btn-group-sm">';
...
//            tool += '</div>';
            ...
            tool += '</div>';
			 ...
			 tool += '<div class="btn-group btn-group-sm dropdown">';
            tool += '<button class="btn btn-default dropdown-toggle" title="Add Patient Info" id="add-patient-info" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">Add Patient Info <span class="caret"></span></button>';
			tool += '<ul class="dropdown-menu" aria-labelledby="add-patient-info"><li><a href="#">Address</a></li><li><a href="#">Age</a></li><li><a href="#">Date of Birth</a></li><li><a href="#">Email</a></li><li><a href="#">Patient Name</a></li><li><a href="#">Phone</a></li></ul>';
            tool += '</div>';

			
            tool += '</div>';
            tool += '<div contenteditable="true" class="editor-content" data-editor-id="e' + i + '" style="display: inline-block;border: solid 1px #e0e0e0;border-radius: 0px;min-height: 200px;padding:10px;width: 100%;"></div>';
			...
			tool += '<button id="justify' + i + '" class="btn btn-default" title="Justify"><span class="glyphicon glyphicon-align-justify"></span></button>';
	...
	$("[data-cedit='justify']").click(function (e) {
        document.execCommand('justifyRight', false, null);
    });
