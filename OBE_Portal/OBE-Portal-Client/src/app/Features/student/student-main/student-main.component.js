...
let StudentMainComponent = class StudentMainComponent {
    ...
    LoadStudentDashboard() {
        ...
        this._StudentService.GetPLOsResultForStudent(GlobalService.StudentID).subscribe(response => {
            this.PLO1 = 0;
            this.PLO2 = 0;
            this.PLO3 = 0;
            this.PLO4 = 0;
...
StudentMainComponent = __decorate([
    Component({
...
export { StudentMainComponent };
//# sourceMappingURL=student-main.component.js.map