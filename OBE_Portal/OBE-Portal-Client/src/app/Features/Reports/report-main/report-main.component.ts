...
export class ReportMainComponent implements OnInit {
  PLOAnalysis: boolean = false;
  PLOAnalysisNew: boolean = false;
  CourseMarkStatus: boolean = false;
  SkillCoverage: boolean = false;
  PLOsCoverage: boolean = false;
  PLOsCoverageCourseWise: boolean = false;
  CourseAssessmentReport: boolean = false;
  CompiledResultReport: boolean = false;
  CLOPLOMapping: boolean = false;
  CLOPLOSkillMapping: boolean = false;
  CLOAttainmentSemesterwise: boolean = false;
  CLOFailedSemesterwise: boolean = false;
  CQICourseExecutiveSummary: boolean = false;
  CQIPLOQuhartLevelFailureSummary: boolean = false;
  CSPSummary: boolean = false;
  ExitSummary: boolean = false;
  InternshipSummary: boolean = false;

  Is_Permission_Course_Marks_Status: boolean = false;
  Is_Permission_PLOs_Analysis: boolean = false;
  Is_Permission_Reports_Main: boolean = false;
  Is_Permission_Skills_Coverage: boolean = false;
  Is_Permission_PLOs_Coverage: boolean = false;
  Is_Permission_Course_Assessment_Resport: boolean = false;
  Is_Permission_PLOs_Main_Reporting_Widget: boolean = false;
  Is_Permission_CLOs_And_Assessment_Main_Reporting_Widget: boolean = false;
  Is_Permission_Compiled_Result_Report: boolean = false;
  Is_Permission_PLOs_Coverage_Course_Wise: boolean = false;
  Is_Permission_CLO_PLO_Mapping: boolean = false;
  Is_Permission_CLO_PLO_Skill_Mapping: boolean = false;
  Is_Permission_CLO_Attainment_SemesterWise: boolean = false;
  Is_Permission_CLO_Failed_SemesterWise: boolean = false;
  Is_Permission_CQI_Main_Widget: boolean = false;
  Is_Permission_CQI_Course_Executive_Summary: boolean = false;
  Is_Permission_CQI_PLO_Quhart_Level_Failure_Summary: boolean = false;
  Is_Permission_Indirect_Main_Widget: boolean = false;
  Is_Permission_CSP_Summary: boolean = false;
  Is_Permission_Exit_Summary: boolean = false;
  Is_Permission_Internship_Summary: boolean = false;
