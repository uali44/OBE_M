...
export class PloSkillsMappingComponent implements OnInit {
  Institutes: [] = [];
  Department: [] = [];
  Intake: [] = [];
  Skill_Coverage: any[] = [];
  ...
  Total_Number_Of_Affective_Count: number;
  Total_Number_Of_Cognitive_Count: number;
  Total_Number_Of_Psychomotor_Count: number;
