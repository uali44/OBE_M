...
let CourseMarksStatusComponent = class CourseMarksStatusComponent {
    constructor(_CoursesSearchService, toastr, ngxService, _ReportsService, pagerService, CompiledResultservice) {
        this._CoursesSearchService = _CoursesSearchService;
        this.toastr = toastr;
        this.ngxService = ngxService;
        this._ReportsService = _ReportsService;
        this.pagerService = pagerService;
        this.CompiledResultservice = CompiledResultservice;
        this.Institutes = [];
        this.Department = [];
        this.All_Semester = [];
    ...
    onStatusChange(val, CourseCategory, Status) {
    ...
    onCourseCategoryChange(val, Status) {
        Swal.fire({
    ...
    updateFacultyAssigned(FacultyMemberID, OfferedCourseID) {
        Swal.fire({
...
CourseMarksStatusComponent = __decorate([
    Component({
...
], CourseMarksStatusComponent);
export { CourseMarksStatusComponent };
//# sourceMappingURL=course-marks-status.component.js.map