...
let CompiledResultComponent = class CompiledResultComponent {
    constructor(CompiledResultservice, toastr, pagerService, ngxService, _CoursesSearchService, AssignedCoursesservice) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                this._CoursesSearchService.DeleteStudentFromCourse(Number(value.RegisteredCourseID)).
                    ...
                    this.ngxService.stop();
                    if (data) {
                        Swal.fire('Deleted!', 'Student removed from selected course successfully.', 'success');
...
CompiledResultComponent = __decorate([
    Component({
...
], CompiledResultComponent);
export { CompiledResultComponent };
//# sourceMappingURL=compiled-result.component.js.map