...
export class DashboardMainComponent implements OnInit {
  ...
  Dashboard_Request_Search: Dashboard_Request;
  Dashboard_Response: any;
  Assessment_Averages: any[] = [];
  Assessment_Averages_Graph_Data: any[] = [];
  CLOS_Averages_Graph_Data: any[] = [];
  Categories: any[] = [];
  Assignment_Or_Assessment: any[] = [];
  Quiz_Or_Journals: any[] = [];
  Assessment: any[] = [];
  Journals: any[] = [];
  Mids: any[] = [];
  Finals: any[] = [];
  Assessment_Average: any[] = [];
  CLOS_Average: any[] = [];
  CLOS_Assessment_Comparison: any[] = [];
  All_Courses_CLOS_Attainment: any[] = []

  Assigned_Course_Count: number = 0;
  All_Courses_CLOS_Count: number = 0;
  All_Assessment_Averages: number = 0;
  Sum_Of_All_CLOS_Marks: number = 0;
  CLOS_Attainment: number = 0;
  Sum_Of_Course_Wise_CLOS: number = 0;
  Sum_Of_All_CLOS_Assessment_Attainment: number = 0;
