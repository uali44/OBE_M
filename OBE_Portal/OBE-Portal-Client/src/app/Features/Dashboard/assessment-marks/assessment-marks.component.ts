...
import { AssessmentMarksService } from '../../../Services/AssessmentMarks/assessmentMarks.service';
...
export class AssessmentMarksComponent implements OnInit {
  Registered_Students: any[] = [];
  Added_Assessments: any[] = [];
  Assessment_Marks_Final: any[] = [];
  Assessment_And_Student_Details: any[] = [];
  Added_Marks_For_Excel: any[] = [];
  dataset: any[] = [];
  Update_Marks: any[] = [];
  Updated_Marks: any[] = [];
  pager: any = {};
  ...
  pagesize: number = 50;
  serialNumber: number;
  Question_Marks: number = 0;
  Assessment_Marks_ID: number = 0;
  Index: number = 0;
  ...
  constructor(
    private AssessmentMarksService: AssessmentMarksService,
