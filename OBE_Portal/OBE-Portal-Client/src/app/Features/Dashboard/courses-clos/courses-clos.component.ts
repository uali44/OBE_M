...
export class CoursesClosComponent implements OnInit {
  Get_Course_CLOS: any;
  All_PLOS: any[] = [];
  All_PLOS_Skill: any[] = [];
  All_PLOS_Skill_level: any[] = [];
  All_PLOS_Skill_level_temp: any[] = [];
  All_Added_CLOS: any[] = [];
  CourseCLOSForm; CourseCLOSEditForm: FormGroup;
  submitted = false;
  submitted_Edit = false;
  CLO_Added_Count: number = 0;
  Selected_CLO_ID: number = 0;
  query: string = "";
  pager: any = {};
  page: any;
  pagesize: number = 50;
  ...
  Is_Permission_Add_Course_Details: boolean = false;
  Is_Permission_Edit_Course_Details: boolean = false;
  Is_Permission_Delete_Course_Details: boolean = false;
            ...
            subscribe(
              data => {
                ...
                if (data) {
                  Swal.fire(
                    'Deleted!',
                    'Course CLO deleted successfully.',
                    'success'
                  )
                  this.Get_Selected_Course_CLOS();
                  this.msgForDashboard.UpdateCourseDetailsCounts(GlobalService.TempFacultyMember_ID.toString());
