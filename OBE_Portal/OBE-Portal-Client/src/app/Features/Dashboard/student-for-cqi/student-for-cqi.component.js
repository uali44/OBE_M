...
let StudentForCqiComponent = class StudentForCqiComponent {
    constructor(toastr, ngxService, _ReportsService, pagerService) {
        this.toastr = toastr;
    ...
    GetAllStudentOfCourseInWhichStudentPassedButCLOsFailed() {
        ...
        this._ReportsService.GetAllStudentOfCourseInWhichStudentPassedButCLOsFailed(this.Offered_Course_ID).
            ...
            if (response != null) {
                ...
                var flags = [];
                for (var i = 0; i < ((_a = this.dataset) === null || _a === void 0 ? void 0 : _a.length); i++) {
                    if (flags[this.dataset[i].CourseCLOID])
                        continue;
...
StudentForCqiComponent = __decorate([
    Component({
...
], StudentForCqiComponent);
export { StudentForCqiComponent };
//# sourceMappingURL=student-for-cqi.component.js.map