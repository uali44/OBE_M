...
import { AssessmentDetailsService } from './../../../Services/AssessmentDetails/assessmentDetails.service'
...
export class AssessmentDetailsComponent implements OnInit {
  ...
  CourseAssessmentFormEdit;
  CourseAssessmentFormLab;
  CourseAssessmentFormEditLab;
  CourseAssessmentFormFYP;
  CourseAssessmentFormEditFYP: FormGroup;
  query: string = "";
  Get_Assessment_Details_Course: any;
  Get_Added_CLOS: any;
  Get_Assessment_Details_Course_Lst: any;
  Get_Assessment_Sub_Details_Course_Lst: any;
  Selected_Assessment_Title: any;
  Selected_Assessment_ID: any;
  Selected_Assessment_Remarks: any;
  pager: any = {};
  page: any;

  Min_Date: Date = new Date();
  Selected_Assessment_Scheduled_Date: Date;

  Assignment_Initial_Array: any[] = [];
  Quizzes_Initial_Array: any[] = [];
  Assessment_Initial_Array: any[] = [];
  Journals_Initial_Array: any[] = [];
  All_Added_Assessment_For_Final_Submission: any[] = [];
  All_Added_Assessment_Details: any[] = [];
  All_Added_Assessment_Details_Lab: any[] = [];
  All_Added_Assessment_Details_FYP: any[] = [];
  All_Added_Assessment_Temp: any[] = [];
  Selected_Assessment_Sub_Details: any[] = [];
  Lab_Performance_Indicator: any[] = [];
  FYPAssessmentToolsStatus: any[] = [];
  dataset: any[] = [];

  submitted = false;
  submitted_Edit = false;
  Is_Mid_Marks_Added: boolean = false;
  Is_Finals_Marks_Added: boolean = false;
  Is_Course: boolean = false;
  Is_Weightage_Mendatory: boolean = false;
  Is_Temp_Mids_And_Finals: boolean = false;
  Is_Completed: boolean;
  Is_Permission_Add_Course_Details: boolean;
  Is_Permission_Edit_Course_Details: boolean;
  Is_Permission_Delete_Course_Details: boolean;
  Is_Show_Action_TD: boolean = true;
  Is_Have_Special_Permission: boolean = false;
  Add_Permission: boolean = false;

  Assessment_Type: number = 1;
  Assessment_Type_Lab: number = 1;
  Question_Number: number = 1;
  Assiggment_Added_Count: number = 0;
  Quiz_Added_Count: number = 0;
  Assessment_Added_Count: number = 0;
  Journal_Added_Count: number = 0;
  Assessment_Total_Marks: number = 0;
  Assessment_Sub_Details_ID_For_Edit: number = 0;
  Assessment_Sub_Details_Index_For_Edit: number = 0;
  pagesize: number = 50;
  serialNumber: number;
  CourseCategory: number;
  TotalMarks: number = 0;
  AssessmentToolFYPTotalMarks: number = 0;
  constructor(
      ...
      subscribe(
        data => {
          ...
          if (data != null) {
            ...
            if (this.Get_Assessment_Details_Course?.length > 0) {
